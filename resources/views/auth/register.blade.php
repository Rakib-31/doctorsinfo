                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hospital" type="text" class="form-control @error('hopital') is-invalid @enderror" name="hospital" value="{{ old('hospital') }}" required autocomplete="hospital">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="detail" type="detail" class="form-control @error('detail') is-invalid @enderror" name="detail" value="{{ old('detail') }}" required autocomplete="detail">
